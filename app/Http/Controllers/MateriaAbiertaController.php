...
class MateriaAbiertaController extends Controller
{
    ...
    //         if (substr($key, 0, 1) == 'm') {
    //             $existe = $this->ma->firstWhere('materia_id', $request->$key);
    //             if ($this->periodo_id != "-1" and $this->carrera_id != "-1") {
    //                 MateriaAbierta::create([
    //                     'periodo_id' => $this->periodo_id,
    //                     'carrera_id' => $this->carrera_id,
    //                     'materia_id' => $value
    ...
    // public function show(MateriaAbierta $materiasAbiertas)
    // {

    // }

    // public function edit(MateriaAbierta $materiasAbiertas)
    // {

    // }

    // public function update(Request $request, MateriaAbierta $materiasAbiertas)
    // {

    // }

    // public function destroy(MateriaAbierta $materiasAbiertas)
    // {
    //     $materiasAbiertas->delete();
    //     return "aqui voy";
    //     return redirect()->route('materiasa.index');
    // }
}